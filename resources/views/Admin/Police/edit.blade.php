...
<form method="POST" action="{{route('admin.police.update', $police->id)}}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <img src="{{asset($police->third_p_img[0])}}" alt="" style="width: 100px;height: 100px;display: block;margin-bottom: 20px;border-radius: 5px">
        <input type="file" class="form-control" id="img" name="third_p_img[]"  multiple>
    </div>
    <div class="form-group">
