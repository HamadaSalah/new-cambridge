...
@section('content')
<h2 style="padding-bottom: 35px;float: left;">Edit Primary </h2>

<div class="clearfix"></div>

<form method="POST" action="{{route('admin.primary.update', $police->id)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <br>
    <div class="form-group">
        ...
        <input type="file" class="form-control" id="img" name="sec1_img[]"   multiple> 
    </div>
    <div class="form-group">
