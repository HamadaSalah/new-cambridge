    ...
    <div class="container">
        <div class="row flex-column-reverse flex-md-column-reverse flex-lg-row flex-xl-row flex-xxl-row">
            <div style="float: right">
                <img src="{{asset($kg->sec2_img)}}" alt="" class="img-fluid rounded-3" style="width: 50%;float: left;margin: 20px 20px 20px 0;border-radius: 5px!important">
        ...
        <div class="row flex-column-reverse flex-md-column-reverse flex-lg-row-reverse flex-xl-row-reverse flex-xxl-row-reverse mt-5">
            <div style="float: right">
                <img src="{{asset($kg->sec3_img)}}" alt="" class="img-fluid rounded-3" style="width: 50%;float: left;margin: 20px 20px 20px 0;border-radius: 5px!important">
                    <h3 class="pb-3">{!!$kg->sec3_head!!}</h3>
                    <p class="pb-3 lh-lg m-0 Open_Sans_font">
                        {!!$kg->sec3_p!!}                </p>
                </div>
        </div>
